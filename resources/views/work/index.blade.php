<x-layout title="Travail" description="Projets de Modeste Konlani — applications métier, hackathons, CI/CD.">
    <section class="site-wrap pt-16 pb-10 md:pt-24" data-reveal>
        ...
        <div class="mt-4 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <h1 class="font-display text-5xl font-extrabold tracking-tight md:text-6xl">Travail</h1>
